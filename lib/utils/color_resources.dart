...
class ColorResources {
  ...
  static Color getSplashColor1() {
    return const Color(0xFFCC003F).withOpacity(.15);
  }

  static Color getTextColor() {
    return const Color(0xFF25282B);
  }

  static Color getTitleColor() {
    return const Color(0xFF003473);
  }

  static Color getCheckoutTextColor() {
    return const Color(0xFF4C5D70);
  }

  static Color getCategoryWithProductColor() {
    return const Color(0xFFBDC1C4);
  }
  ...
  static Color getSplashColor2() {
    return const Color(0xFF003473).withOpacity(.15);
  }

  static Color revenueCardOneColor() {
    return const Color(0xFF286FC6);
  }

  static Color revenueCardTwoColor() {
    return const Color(0xFF5ABD88);
  }

  static Color revenueCardOThreeColor() {
    return const Color(0xFFD0517F);
  }

  static Color getResetColor() {
    return const Color(0xFFECF1F7);
  }
